...
<p align="center">
  ...
  3 apps live on the App Store · LLM integration (OpenAI, Gemini, Claude) · SwiftUI · StoreKit 2
</p>
...
- 🤖 I integrate **practical AI features** into real products — LLM APIs (OpenAI, Gemini, Claude), prompt engineering, context injection, and conversational UX.
- 📱 **3 apps live on the App Store**, including **SpeachyAI** (1,000+ downloads), built end-to-end from concept to monetization.
...
- 💬 Ask me about **SwiftUI, StoreKit 2, or shipping LLM features into mobile apps**.
